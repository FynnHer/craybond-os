/*
shared/process_loader.c
This file implements the process loader for user processes. It provides functions to
create user processes by allocating memory for their code and data segments, relocating
code as necessary, and setting up their initial stack and registers.
*/
            ...
            */
            ...
            if (internal) {
                ...
                */
                ...
                kprintf_raw("[ERROR]: Symbol not supported");
            }
        }
